...
\name{}{Daniel Crawford}
% \address{Seattle, WA}
\mobile{(+1) 817-228-9461}

\email{daniel.sc.crawford@gmail.com}
\github{dscrawford}
\linkedin{daniel-sc-crawford}
%\skype{skypeid}
...
% \position{Data Scientist {\enskip\cdotp\enskip}Machine Learning Engineer} % Your expertise/fields

% \makecvfooter{}{Daniel Crawford ~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
